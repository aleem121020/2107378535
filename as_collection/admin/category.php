...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "insert into category(categoryName,categoryDescription,meta_title,meta_description,meta_keywords,canonical,h1_title) values('$category','$description','$meta_title','$meta_description','$meta_keywords','$canonical','$h1_title')");
